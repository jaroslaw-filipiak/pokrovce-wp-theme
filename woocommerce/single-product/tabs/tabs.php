...
<section class="woocommerce-tabs wc-tabs-wrapper py-20 overflow-hidden bg-gray-2">
    <div class="w-full px-4 mx-auto max-w-7xl sm:px-6 xl:px-0">
        <ul class="tabs wc-tabs flex flex-wrap items-center bg-white rounded-[10px] shadow-1 gap-5 xl:gap-12.5 py-4.5 px-4 sm:px-6"
            role="tablist">
            <?php foreach ( $product_tabs as $key => $product_tab ) : ?>
            <li role="presentation" class="<?php echo esc_attr( $key ); ?>_tab"
                id="tab-title-<?php echo esc_attr( $key ); ?>">
                <a href="#tab-<?php echo esc_attr( $key ); ?>"
                    class="font-medium lg:text-lg ease-out duration-200 hover:text-[#E67E22]" role="tab"
