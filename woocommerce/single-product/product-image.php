...
<div class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>"
    ...
    <div class="aspect-square rounded-lg shadow-1 overflow-hidden relative">
        <div class="woocommerce-product-gallery__wrapper">
            <!-- Zoom Button -->
            <button aria-label="<?php esc_attr_e( 'Zoom', 'pokrovce' ); ?>"
                class="gallery__Image w-11 h-11 rounded-full bg-gray-1 shadow-1 flex items-center justify-center ease-out duration-200 text-dark hover:text-[#E67E22] absolute top-4 lg:top-6 right-4 lg:right-6 z-50">
                <svg class="w-6 h-6" width="24" height="24" viewBox="0 0 25 24" fill="none"
