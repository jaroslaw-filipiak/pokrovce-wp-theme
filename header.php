                ...
                <div
                    ...
                    <div class="flex w-full lg:w-auto items-center gap-7.5">
                        ...
                        <div class="flex w-full lg:w-auto justify-between items-center gap-5">
                            ...
                            <button id="navToggle" aria-label="Toggler" class="xl:hidden block">
                                <span class="block relative cursor-pointer w-5.5 h-5.5">
                                    <span class="du-block absolute right-0 w-full h-full">
                                        <span
                                            class="block relative top-0 left-0 bg-dark rounded-sm w-full h-0.5 my-1 ease-in-out duration-200 delay-300 nav-line-1"></span>
                                        <span
                                            class="block relative top-0 left-0 bg-dark rounded-sm w-full h-0.5 my-1 ease-in-out duration-200 delay-400 nav-line-2"></span>
                                        <span
                                            class="block relative top-0 left-0 bg-dark rounded-sm w-full h-0.5 my-1 ease-in-out duration-200 delay-500 nav-line-3"></span>
                                    </span>
                                </span>
                            </button>
                            <!-- Hamburger Toggle BTN -->
