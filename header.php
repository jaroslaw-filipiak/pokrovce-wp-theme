                ...
                <div
                    ...
                    <div
                        ...
                        <a class="flex-shrink-0" href="<?php echo esc_url( home_url( '/' ) ); ?>">
                            ...
                            <?php the_custom_logo(); ?>
                            <?php else : ?>
                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/logo/logo.svg"
                                alt="<?php bloginfo( 'name' ); ?>" width="219" height="36">
                            <?php endif; ?>
                        </a>
                    ...
                    <div class="flex w-full lg:w-auto items-center gap-7.5">
                        <div class="hidden xl:flex items-center gap-3.5">
                            ...
                            <div>
                                <span class="block text-2xs text-dark-4 uppercase">24/7 SUPPORT</span>
                                <p class="font-medium text-custom-sm text-dark">(+965) 7492-3477</p>
                            </div>
                        </div>
                                ...
                                <a href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>"
                                    ...
                                    <a href="<?php echo esc_url( wc_get_cart_url() ); ?>"
                                        ...
                                        <span class="inline-block relative">
                                            ...
                                            <span
                                                class="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-blue w-4.5 h-4.5 rounded-full text-white cart-count">
                                                <?php echo WC()->cart->get_cart_contents_count(); ?>
                                            </span>
                                        </span>

                                        <div>
                                            <span class="block text-2xs text-dark-4 uppercase">cart</span>
