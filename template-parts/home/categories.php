...
?>
<section class="overflow-hidden pt-17.5">
    <div class="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0 pb-15 border-b border-gray-3">
        <div class="swiper categories-carousel common-carousel">
            <!-- section title -->
            <div class="mb-10 flex items-center justify-between">
                <div>
                    <span class="flex items-center gap-2.5 font-medium text-dark mb-1.5">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_834_7356)">
                                ...
                                <circle cx="7.17245" cy="7.39917" r="1.66667" transform="rotate(-45 7.17245 7.39917)" stroke="#3C50E0" stroke-width="1.5"/>
                                <path d="M9.61837 15.4164L15.4342 9.6004" stroke="#3C50E0" stroke-width="1.5" stroke-linecap="round"/>
                            </g>
                            <defs>
                        ...
                        <?php esc_html_e( 'Categories', 'pokrovce' ); ?>
                    </span>
                    <h2 class="font-semibold text-xl xl:text-heading-5 text-dark">
                        <?php esc_html_e( 'Browse by Category', 'pokrovce' ); ?>
                    </h2>
                </div>
                ...
                <?php if ( ! empty( $categories ) && ! is_wp_error( $categories ) ) : ?>
                    ...
                    ?>
                        <div class="swiper-slide">
                            <a href="<?php echo esc_url( get_term_link( $category ) ); ?>" class="flex flex-col items-center group">
