        ...
        <div class="mb-7 flex items-center justify-between">
            <div>
                <span class="flex items-center gap-2.5 font-medium text-dark mb-1.5">
                    ...
                    <?php esc_html_e( "Nasze produkty", 'pokrovce' ); ?>
                </span>
                <h2 class="font-semibold text-xl xl:text-heading-5 text-dark">
                    <?php esc_html_e( 'Wybierz swój kolor', 'pokrovce' ); ?>
                </h2>
            </div>

            <a href="<?php echo esc_url( get_permalink( wc_get_page_id( 'shop' ) ) ); ?>"
                class="inline-flex font-medium text-custom-sm py-2.5 px-7 rounded-md border-gray-3 border bg-gray-1 text-dark ease-out duration-200 hover:bg-dark hover:text-white hover:border-transparent hidden">
                <?php esc_html_e( 'Zobacz wszystkie', 'pokrovce' ); ?>
            </a>
        </div>
