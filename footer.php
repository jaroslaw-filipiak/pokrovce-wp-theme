...
<footer class="overflow-hidden">
    <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        <!-- footer menu start -->
        <div
            class="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
            <div class="max-w-[330px] w-full">
                <h2 class="mb-7.5 text-custom-1 font-medium text-dark">
                    <?php esc_html_e( 'Help & Support', 'pokrovce' ); ?>
                </h2>
                ...
                <ul class="flex flex-col gap-3">
                    ...
                    <li>
                        <a href="tel:+099532786984" class="flex items-center gap-4.5">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li>
                        <a href="mailto:support@example.com" class="flex items-center gap-4.5">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="flex items-center gap-4 mt-7.5">
                    <a href="#" aria-label="Facebook Social Link" class="flex ease-out duration-200 hover:text-blue">
                    ...
                    <a href="#" aria-label="Twitter Social Link" class="flex ease-out duration-200 hover:text-blue">
                    ...
                    <a href="#" aria-label="Instagram Social Link" class="flex ease-out duration-200 hover:text-blue">
                        <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#" aria-label="Linkedin Social Link" class="flex ease-out duration-200 hover:text-blue">
                        <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <div class="w-full sm:w-auto">
                <h2 class="mb-7.5 text-custom-1 font-medium text-dark">
                    <?php esc_html_e( 'Account', 'pokrovce' ); ?>
                </h2>
                ...
                <ul class="flex flex-col gap-3.5">
                    ...
                    <li>
                        <a class="ease-out duration-200 hover:text-blue"
                            ...
                            <?php esc_html_e( 'My Account', 'pokrovce' ); ?>
                        </a>
                    </li>
                    <li>
                        <a class="ease-out duration-200 hover:text-blue"
                            href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>">
                            <?php esc_html_e( 'Login / Register', 'pokrovce' ); ?>
                        </a>
                    </li>
                    <li>
                        <a class="ease-out duration-200 hover:text-blue"
                            href="<?php echo esc_url( wc_get_cart_url() ); ?>">
                            <?php esc_html_e( 'Cart', 'pokrovce' ); ?>
                        </a>
                    </li>
                    <li>
                        <a class="ease-out duration-200 hover:text-blue" href="#">
            ...
            <div class="w-full sm:w-auto">
                <h2 class="mb-7.5 text-custom-1 font-medium text-dark">
                    <?php esc_html_e( 'Quick Link', 'pokrovce' ); ?>
                </h2>
                ...
                <ul class="flex flex-col gap-3">
                    <li><a class="ease-out duration-200 hover:text-blue"
                            href="<?php echo esc_url( get_privacy_policy_url() ); ?>"><?php esc_html_e( 'Privacy Policy', 'pokrovce' ); ?></a>
                    </li>
                    <li><a class="ease-out duration-200 hover:text-blue"
                            href="#"><?php esc_html_e( 'Refund Policy', 'pokrovce' ); ?></a></li>
                    <li><a class="ease-out duration-200 hover:text-blue"
                            href="#"><?php esc_html_e( 'Terms of Use', 'pokrovce' ); ?></a></li>
                    <li><a class="ease-out duration-200 hover:text-blue"
                            href="#"><?php esc_html_e( "FAQ's", 'pokrovce' ); ?></a></li>
                    <li><a class="ease-out duration-200 hover:text-blue"
                            href="#"><?php esc_html_e( 'Contact', 'pokrovce' ); ?></a></li>
                </ul>
                <?php
                        },
                    ) );
            ...
            <div class="w-full sm:w-auto">
                <h2 class="mb-7.5 text-custom-1 font-medium text-dark lg:text-right">
                    <?php esc_html_e( 'Download App', 'pokrovce' ); ?>
                </h2>

                <p class="lg:text-right text-custom-sm mb-4">
                    <?php esc_html_e( 'Save $3 With App & New User only', 'pokrovce' ); ?>
                </p>

                <ul class="flex flex-col lg:items-end gap-3">
                    <li>
                        <a class="inline-flex items-center gap-3 py-[9px] pl-4 pr-7.5 text-white rounded-md bg-dark ease-out duration-200 hover:bg-opacity-95"
                            href="#">
                            <svg class="fill-current" width="34" height="35" viewBox="0 0 34 35" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <div>
                                <span
                                    class="block text-custom-xs"><?php esc_html_e( 'Download on the', 'pokrovce' ); ?></span>
                    ...
                    <li>
                        <a class="inline-flex items-center gap-3 py-[9px] pl-4 pr-8.5 text-white rounded-md bg-blue ease-out duration-200 hover:bg-opacity-95"
                            href="#">
                            <svg class="fill-current" width="34" height="35" viewBox="0 0 34 35" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <div>
                                <span
                                    class="block text-custom-xs"><?php esc_html_e( 'Get in On', 'pokrovce' ); ?></span>
    ...
    <!-- footer bottom start -->
    <div class="py-5 xl:py-7.5 bg-gray-1">
        <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
            <div class="flex gap-5 flex-wrap items-center justify-between">
                <p class="text-dark font-medium">
                    &copy; <?php echo esc_html( $year ); ?>.
                    <?php esc_html_e( 'All rights reserved by', 'pokrovce' ); ?> <?php bloginfo( 'name' ); ?>.
                </p>

                <div class="flex flex-wrap items-center gap-4">
                    <p class="font-medium"><?php esc_html_e( 'We Accept:', 'pokrovce' ); ?></p>

                    <div class="flex flex-wrap items-center gap-6">
                        <a href="#" aria-label="payment system with visa card">
                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/payment/payment-01.svg"
                                alt="visa card" width="66" height="22">
                        </a>
                        <a href="#" aria-label="payment system with paypal">
                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/payment/payment-02.svg"
                                alt="paypal" width="18" height="21">
                        </a>
                        <a href="#" aria-label="payment system with master card">
                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/payment/payment-03.svg"
                                alt="master card" width="33" height="24">
                        </a>
                        <a href="#" aria-label="payment system with apple pay">
                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/payment/payment-04.svg"
                                alt="apple pay" width="53" height="22">
                        </a>
                        <a href="#" aria-label="payment system with google pay">
                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/payment/payment-05.svg"
                                alt="google pay" width="56" height="22">
                        </a>
                    </div>
                </div>
            </div>
