        ...
        <div
            ...
            <div class="max-w-[330px] w-full">
                <h2 class="mb-7.5 text-custom-1 font-medium text-dark">
                    <?php esc_html_e( 'Kontakt', 'pokrovce' ); ?>
                </h2>
                ...
                <ul class="flex flex-col gap-3">
                    <li class="flex gap-4.5">
                        ...
                        64-330 Opalenica, Kozłowo 37
                        NIP: 7881922096
                        REGON: 367974829
                    </li>

                    <li>
                        <a href="tel:+48661962732" class="flex items-center gap-4.5">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li>
                        <a href="mailto:kontakt@pokrovce.pl" class="flex items-center gap-4.5">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
            <div class="flex gap-5 flex-wrap items-center justify-between">
                <p class="text-dark font-medium">
                    ...
                    <?php esc_html_e( '', 'pokrovce' ); ?> <?php bloginfo( 'name' ); ?> | Wykonanie:
                    <a href="https://j-filipiak.pl">j-filipiak.pl</a>
                </p>

                <div class="flex flex-wrap items-center gap-4">
                    <p class="font-medium"><?php esc_html_e( 'Bezpieczne płatności:', 'pokrovce' ); ?></p>

                    <div class="flex flex-wrap items-center gap-6">
                        <a href="#" aria-label="payment system with visa card">
                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/public/images/payment/payment-01.svg"
                                alt="visa card" width="66" height="22">
                        </a>
                        <a href="#" aria-label="payment system with paypal">
                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/public/images/payment/payment-02.svg"
                                alt="paypal" width="18" height="21">
                        </a>
                        <a href="#" aria-label="payment system with master card">
                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/public/images/payment/payment-03.svg"
                                alt="master card" width="33" height="24">
                        </a>
                        <a href="#" aria-label="payment system with apple pay">
                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/public/images/payment/payment-04.svg"
                                alt="apple pay" width="53" height="22">
                        </a>
                        <a href="#" aria-label="payment system with google pay">
                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/public/images/payment/payment-05.svg"
