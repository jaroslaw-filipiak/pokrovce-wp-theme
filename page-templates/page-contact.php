    ...
    <section class="contact-cards mb-12">
        <div class="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Email card -->
                <a href="mailto:kontakt@pokrovce.pl"
                    ...
                    <div
                        ...
                        <svg class="text-[#E67E22] group-hover:text-white transition-colors duration-300" width="28"
                            height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <a href="tel:+48661962732"
                    ...
                    <p class="text-[#E67E22] font-medium">+48 661 962 732</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-10">
                ...
                <div class="lg:col-span-2">
                    ...
                    <p class="text-dark-3 mb-6">
                        Wypełnij formularz, a my odpowiemy tak szybko, jak to możliwe. Możesz też skontaktować się z
                        nami bezpośrednio przez email lub telefon.
                    </p>
                    ...
                    <div class="bg-gray-1 rounded-xl p-5 mb-6">
                        ...
                        <a href="<?php echo esc_url(home_url('/faq')); ?>"
                            class="inline-flex items-center gap-2 text-[#E67E22] font-medium text-custom-sm hover:gap-3 transition-all duration-200">
                            Przejdź do FAQ
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.33334 8H12.6667" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M8 3.33334L12.6667 8L8 12.6667" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </a>
                    </div>
                        ...
                        <div class="flex items-center justify-center w-10 h-10 bg-green/10 rounded-lg flex-shrink-0">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="#22AD5C" stroke-width="1.5" />
                                <path d="M10 5.83334V10L13.3333 11.6667" stroke="#22AD5C" stroke-width="1.5"
